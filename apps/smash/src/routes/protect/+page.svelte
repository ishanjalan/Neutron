...
<div class="flex min-h-screen flex-col">
	...
	<div class="fixed inset-0 -z-10 overflow-hidden">
		<div
			class="absolute -top-1/2 -right-1/4 h-[800px] w-[800px] rounded-full bg-gradient-to-br from-green-500/10 to-emerald-500/10 blur-3xl"
		></div>
	</div>
	...
	<main class="flex-1 px-4 pt-28 pb-12 sm:px-6 lg:px-8">
		...
		<SEOSection
			intro={protectSEO.intro}
			faqs={protectSEO.faqs}
			breadcrumbs={[
				{ name: 'Smash', item: 'https://ishanjalan.github.io/Smash/' },
				{ name: 'Protect PDF', item: 'https://ishanjalan.github.io/Smash/protect' },
			]}
		/>
	</main>
