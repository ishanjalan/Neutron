...
<div class="space-y-3">
	...
	>
		...
		<div
			class="absolute top-0 bottom-0 cursor-grab border-y-2 border-pink-500/50 bg-gradient-to-r from-pink-500/30 to-rose-500/30 active:cursor-grabbing"
		...
		{#if currentTime >= startTime && currentTime <= endTime}
			<div
				class="pointer-events-none absolute top-0 bottom-0 z-10 w-0.5 bg-white/80"
		...
		<!-- Start handle -->
		<div
			class="group absolute top-0 bottom-0 z-20 w-4 cursor-ew-resize"
		...
		>
			<div
				class="absolute top-0 bottom-0 left-1/2 w-1 -translate-x-1/2 rounded-full bg-pink-500 transition-all group-hover:w-1.5"
			>
				<div
		...
		>
			<div
				class="absolute top-0 bottom-0 left-1/2 w-1 -translate-x-1/2 rounded-full bg-rose-500 transition-all group-hover:w-1.5"
			>
				<div
