		...
		<div class="mb-6 grid grid-cols-2 gap-4">
			...
			<div class="bg-surface-800/50 rounded-xl p-4">
				<div class="mb-1 flex items-center gap-2">
					...
					<span class="text-surface-500 text-xs tracking-wide uppercase">Files</span>
				</div>
			...
			<div class="bg-surface-800/50 rounded-xl p-4">
				<div class="mb-1 flex items-center gap-2">
					...
					<span class="text-surface-500 text-xs tracking-wide uppercase">Saved</span>
				</div>
			...
			<div class="bg-surface-800/50 rounded-xl p-4">
				<div class="mb-1 flex items-center gap-2">
					<span class="text-surface-500 text-xs tracking-wide uppercase">Before</span>
				</div>
			...
			<div class="bg-surface-800/50 rounded-xl p-4">
				<div class="mb-1 flex items-center gap-2">
					<span class="text-surface-500 text-xs tracking-wide uppercase">After</span>
				</div>
