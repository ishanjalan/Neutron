...
<div class="flex min-h-screen flex-col">
	...
	<div class="fixed inset-0 -z-10 overflow-hidden">
		<div
			class="absolute -top-1/2 -right-1/4 h-[800px] w-[800px] rounded-full bg-gradient-to-br from-amber-500/10 to-orange-500/10 blur-3xl"
		></div>
		<div
				...
				<div class="grid gap-6 lg:grid-cols-2" in:fly={{ y: 20, duration: 300 }}>
					...
					<div class="glass rounded-2xl p-4">
						<div
							...
							class="bg-surface-900 relative overflow-hidden rounded-xl select-none"
						...
						>
							...
							>
								...
								<div
									class="absolute -top-2.5 -left-2.5 h-5 w-5 cursor-nw-resize touch-none rounded-sm bg-amber-400 sm:-top-1.5 sm:-left-1.5 sm:h-3 sm:w-3"
									onmousedown={(e) => {
										e.stopPropagation();
								...
								></div>
								<div
									class="absolute -top-2.5 -right-2.5 h-5 w-5 cursor-ne-resize touch-none rounded-sm bg-amber-400 sm:-top-1.5 sm:-right-1.5 sm:h-3 sm:w-3"
									onmousedown={(e) => {
										e.stopPropagation();
								...
								></div>
								<div
									class="absolute -right-2.5 -bottom-2.5 h-5 w-5 cursor-se-resize touch-none rounded-sm bg-amber-400 sm:-right-1.5 sm:-bottom-1.5 sm:h-3 sm:w-3"
									onmousedown={(e) => {
										e.stopPropagation();
								...
								></div>
								<div
									class="absolute top-1/2 -left-2.5 h-8 w-5 -translate-y-1/2 cursor-w-resize touch-none rounded-sm bg-amber-400 sm:-left-1.5 sm:h-6 sm:w-3"
									onmousedown={(e) => {
										e.stopPropagation();
								...
								></div>
								<div
									class="absolute top-1/2 -right-2.5 h-8 w-5 -translate-y-1/2 cursor-e-resize touch-none rounded-sm bg-amber-400 sm:-right-1.5 sm:h-6 sm:w-3"
									onmousedown={(e) => {
										e.stopPropagation();
