...
<svelte:head>
	...
	<title>Swirl - Modern GIF Tools</title>
	<meta
		name="description"
		content="Convert videos to GIF, optimize, resize, reverse, crop, and split animations. 10 browser-based GIF tools. 100% private — files never leave your device."
	/>

	<!-- Open Graph -->
	<meta property="og:type" content="website" />
	<meta property="og:url" content={siteUrl} />
	<meta property="og:title" content="Swirl - Modern GIF Tools" />
	<meta
	...
	<meta name="twitter:title" content="Swirl - Modern GIF Tools" />
	<meta
