		...
		<div class="mb-8 text-center">
			...
			<div class="grid grid-cols-4 gap-3 sm:gap-4">
				...
				>
					...
					>
						<div
							class="flex h-10 w-10 items-center justify-center rounded-lg bg-gradient-to-br from-emerald-500 to-teal-500 sm:h-12 sm:w-12"
						>
							<Image class="h-5 w-5 text-white sm:h-6 sm:w-6" />
						</div>
		...
		<div class="space-y-6 text-center">
			...
			>
				...
				<span class="text-xs font-medium text-green-400 sm:text-sm"
					>Your images never leave your device</span
				>
			</div>
