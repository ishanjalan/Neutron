...
{#if open}
	<div
		class="bg-surface-900 fixed right-4 bottom-4 z-40 w-96 overflow-hidden rounded-2xl shadow-2xl ring-1 ring-white/10"
	...
	>
		...
		{:else if capabilities}
			...
			<div class="border-surface-700/50 border-b p-4">
				<h4 class="text-surface-400 mb-3 text-xs font-semibold tracking-wider uppercase">
					Encoders
				</h4>
			...
			<!-- System Capabilities -->
			<div class="border-surface-700/50 border-b p-4">
				<h4 class="text-surface-400 mb-3 text-xs font-semibold tracking-wider uppercase">System</h4>
				<div class="space-y-2">
					<div class="flex items-center justify-between">
